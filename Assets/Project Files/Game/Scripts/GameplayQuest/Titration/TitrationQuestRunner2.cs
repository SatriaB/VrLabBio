...
namespace FatahDev
{
    public class TitrationQuestRunner2 : QuestRunner
    {
        private static readonly QuestSpec[] DefaultCatalog =
        {
            ...
            new() { id="tit_fill",   title="Isi buret dengan larutan HCl 1M sebanyak 100 ml",        kind=GoalKind.Titration, phase="Contact"},
            new() { id="tit_pour", title="Ambilah larutan natrium dioksida (10 ml) yang telah ditetesi 3 tetes fenolftalin yang belum diketahui konsentrasinya ke dalam erlenmeyer",    kind=GoalKind.Titration, phase="capture"},
            new() { id="tit_tit", title="Titrasi larutan dalam Erlenmeyer dengan larutan HCl di dalam buret hingga terjadi perubahan warna",    kind=GoalKind.Titration, phase="capture"},
            new() { id="tit_stop", title="Hentikan titrasi begitu terjadi perubahan warna",    kind=GoalKind.Titration, phase="capture"},
            new() { id="tit_write", title="Catat volume HCl yang terpakai",    kind=GoalKind.Titration, phase="capture"},
