...
namespace FatahDev
{
    public static class DefineSettings
    {
        ...
        public static readonly RegisteredDefine[] STATIC_REGISTERED_DEFINES = new RegisteredDefine[]
        {
            ...
            // Core
            new RegisteredDefine("MODULE_MONETIZATION", "FatahDev.Monetization"),
            new RegisteredDefine("MODULE_IAP", "UnityEngine.Purchasing.UnityPurchasing"),
            new RegisteredDefine("MODULE_POWERUPS", "FatahDev.PUController"),
            new RegisteredDefine("MODULE_HAPTIC", "FatahDev.Haptic"),
            new RegisteredDefine("MODULE_CURVE", "FatahDev.CurvatureManager"),
