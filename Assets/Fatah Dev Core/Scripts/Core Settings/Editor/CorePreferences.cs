...
namespace FatahDev
{
    public static class CorePreferences
    {
        ...
        public static SettingsProvider CustomPreferencesMenu()
        {
            ...
            SettingsProvider provider = new SettingsProvider("Preferences/Fatah Dev Mobile Core", SettingsScope.User)
            {
                // Label of the preferences page
                label = "Fatah Dev Core",
                ...
                keywords = new string[] { "Custom", "Preferences", "Fatah Dev Core", "Core" }
            };
